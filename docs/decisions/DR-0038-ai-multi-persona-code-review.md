...
| OC/P 2フェーズ | 未記載 | DR-0034 で決定 | DESIGN.md に反映 |
...
| High | DR-0036 の `KuuErrorKind` に対応する `error_code` 未実装 | bridge 全体 |
...
- DR-0034: OC/P 2フェーズ分離
- DR-0035: WASM bridge 全機能対応
- DR-0036: KuuCore 4層アーキテクチャ
- DR-0037: 3直交プリミティブ設計
