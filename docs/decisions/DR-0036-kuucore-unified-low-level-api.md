...
# DR-0036: KuuCore — 各言語向け統一低レベル API 設計
...
DR-0027 で「core は純粋パースエンジン、各言語で高級API」を構想し、DR-0030 で opt AST のポータビリティを確認、DR-0035 で WASM bridge の全機能対応を実装した。
...
- DR-0027: core 純粋関数主義 + 多言語 DX レイヤー構想（本 DR の出発点）
- DR-0030: opt AST の言語間ポータビリティ（KuuCore が活用する基盤）
- DR-0035: WASM bridge 全機能対応（Layer 2 の完成）
