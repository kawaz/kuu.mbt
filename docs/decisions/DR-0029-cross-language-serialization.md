...
kuu は MoonBit core + 多言語 DX レイヤー（DR-0027）の構成。各言語の DX レイヤーが core とやりとりする際、言語境界を越えるデータ表現が必要。
...
- DR-0025 の `custom[T : Show]` / `register_option` も阻害要因なし

## 実装タイミング

- 多言語 DX レイヤーの実装フェーズ（DR-0027 の具体化時）
