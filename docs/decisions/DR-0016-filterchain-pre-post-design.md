...
# DR-0016: FilterChain による pre/post フィルタ設計
...
ユーザーが DR-0016 の設計ドキュメントを直接作成し、DESIGN.md を更新。AI に対して既存実装の品質チェックと機能スキップの検出を指示。
...
- **parse**: 公開 API ラッパー。parse_raw のエラーに error_context を付与
