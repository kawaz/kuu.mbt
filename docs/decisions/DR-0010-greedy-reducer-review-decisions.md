...
# DR-0010: 先食い最長一致 Reducer モデルとマルチペルソナレビュー修正

> **注記**: 本 DR で確立した先食い最長一致モデルは現在も有効です。
> ただし「arity 廃止」「resolve フェーズ廃止」として設計された内容は、さらに DR-0034 (OC/P 2フェーズ分離) で発展しています。
> greedy/non-greedy positional の区別と unclaimed 蓄積による2フェーズ走査は DR-0034 を参照してください。
