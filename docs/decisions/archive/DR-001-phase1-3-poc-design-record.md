...
# Phase 1-3 PoC 設計記録（アーカイブ）

この文書は Phase 1-3 の PoC 設計の記録です。Phase 4 で全面再設計されたため、アーカイブに移動しました。
...
28 パーサの大規模横断調査（`../research/2026-02-24-cli-parser-mega-survey.md`）の知見を踏まえ、理想のパーサを目指す。
