...
# DR-0034: greedy/non-greedy による OC/P フェーズ分離の再導入
...
- DR-0007: greedy の初出（Step 7-8）、OC/P 2層構造の明記（Step 10）
- DR-0010: 先食い最長一致モデル、force_positional の状態変数化（決定事項 9）
- DR-0017: force_positional 廃止、separator_node の ExactNode 化
