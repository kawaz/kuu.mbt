...
# DR-0055: register_option の option/long/short 分解

## 背景

DR-0053 で構想した option/long/short コンビネータの分解を実装する。現在の `register_option` が long/short/variation の全展開を一体で行っているが、これを独立した内部関数に分解する。
