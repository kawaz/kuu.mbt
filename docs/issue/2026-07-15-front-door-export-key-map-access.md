...
- [ ] ekmap 露出の要否と方式 (副戻り値 / AtomicAST 保持 / ヘルパ pub 化 等) を裁定する
- [ ] 裁定結果を front_door の責務定義 (MDR-005) と整合させる
...
- [ ] 上記裏取りに基づく実装方針を mbt-writer worker に委譲し、front_door 側の ekmap 露出を実装する
