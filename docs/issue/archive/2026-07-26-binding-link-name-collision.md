...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-26T23:59:00+09:00
discard_reason:
pending_reason:
close_reason: ["done: Binding.link と Candidate.link (mirror フィールド) を levels_to_declaring_scope に rename (2026-07-26, commit fc7f784f / af76c194)","done: doc コメントも「link」語を使わず書き直し","done: pkg.generated.mbti 追随","done: 520/520 + conformance mismatches=0 + lint green","note: Entity.link (値同期ターゲット) / ElementDef.link_depth / LEnt.link は spec の link 概念とは別物のため対象外"]
blocked_by:
origin: 自リポ TODO
---
