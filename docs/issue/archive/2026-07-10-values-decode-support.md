...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-10T21:07:18+09:00
discard_reason:
pending_reason:
close_reason: ["dr/DR-086","implemented"]
blocked_by:
...
- [x] values decode + or 展開の実装
- [x] `set-always-variant-branch.json` 4 case が green
- [x] `expected_skips` ledger エントリ削除
