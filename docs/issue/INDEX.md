...
|---|---|---|---|---|
| 2026-07-06 | bug | open | [parse-number-bool-dr074-followup](./2026-07-06-parse-number-bool-dr074-followup.md) | DR-074 canonical 字句改訂への slice 追従 (桁区切り/指数/inf/anchored 契約/base_prefix/String→bool) — divergence 14 + skip 1 凍結中 |
| 2026-07-06 | bug | open | [structural-or-builder-missing](./2026-07-06-structural-or-builder-missing.md) | parse_definition に構造 or (多 cell 枝) の builder が無く、path-search の蒸留 fixture 3 本が skip 凍結中 |
