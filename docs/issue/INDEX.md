...
| 2026-08-02 | bug | open | [record-null-fill-missing-in-projection](./2026-08-02-record-null-fill-missing-in-projection.md) | record 座の null 補形が結果射影層に無い (DR-130 §4 / DR-126 §3) — 宣言 ValueType を引く経路が build_result に無い |
