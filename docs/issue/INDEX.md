...
| 2026-07-05 | bug | open | [min2-unbounded-empty-errors](./2026-07-05-min2-unbounded-empty-errors.md) | unbounded repeat{min:2} の min 未達で errors が空 (bounded は held error あり) |
