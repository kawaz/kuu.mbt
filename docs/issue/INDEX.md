...
| 2026-07-09 | bug | wip | [config-string-pieceprocessor-gap](./2026-07-09-config-string-pieceprocessor-gap.md) | config の string 値が pieceProcessor (pre_filters → parse) を通らない (DR-050 乖離) |
| 2026-07-09 | bug | wip | [env-separator-split-gap](./2026-07-09-env-separator-split-gap.md) | separator 付き multiple 要素の env 値が separator 分割されない (DR-049 乖離) |
