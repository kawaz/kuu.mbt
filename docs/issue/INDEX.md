...
| 2026-08-17 | bug | open | [find-help-entry-ignores-help-preset](./2026-08-17-find-help-entry-ignores-help-preset.md) | find_help_entry が FailMark 有無しか見ず on_failure:true の --version を help_entry 扱いする |
...
| 2026-08-16 | task | open | [decode-attribute-carry-allowlist-audit](./2026-08-16-decode-attribute-carry-allowlist-audit.md) | decode面の属性 silent discard 監査 (allowlist⊆carry、A7+R5m1統合、or/seq leaf の env 拒否含む) |
