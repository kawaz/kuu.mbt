...
|---|---|---|---|---|
| 2026-08-17 | bug | open | [nested-env-seat-not-consulted-by-ladder](./2026-08-17-nested-env-seat-not-consulted-by-ladder.md) | 構造子配下 (named group/seq/or leaf) の env 席が値源ラダーから参照されず null のまま。明示 env でも起きる |
| 2026-08-17 | bug | open | [find-help-entry-ignores-help-preset](./2026-08-17-find-help-entry-ignores-help-preset.md) | engine の find_help_entry が FailMark の有無しか見ず、on_failure:true の --version が help_entry になる (公開 node API の設計判断要) |
...
| 2026-08-16 | task | open | [decode-attribute-carry-allowlist-audit](./2026-08-16-decode-attribute-carry-allowlist-audit.md) | decode面の属性 silent discard 監査 (allowlist ⊆ carry 検査、A7+R5 m1 統合)。dec_or_leaf が env を allowlist に載せない逆向きの穴も追記 |
...
| 2026-08-16 | design | open | [multi-token-viability-consistency](./2026-08-16-multi-token-viability-consistency.md) | 多トークン値スロットの viability が失敗様式で非一貫 (DR-097 と DESIGN L438 のどちらに揃えるか裁定要) |
| 2026-08-16 | task | open | [union-tuple-fixture-coverage-gaps](./2026-08-16-union-tuple-fixture-coverage-gaps.md) | union/tuple 系 fixture 網羅の死角。Major指定の複数バグ (C2/C3/A4/C-4等) が未検出だった直接原因 |
| 2026-08-16 | design | open | [absent-vs-null-momentary-old-spec-wording](./2026-08-16-absent-vs-null-momentary-old-spec-wording.md) | union/tuple effects 側 old 表現の absent vs null (momentary) spec 語彙が未統一、裁定要 |
...
| 2026-07-29 | bug | open | [head-progresses-scoped-indexed-unconditional-true](./2026-07-29-head-progresses-scoped-indexed-unconditional-true.md) | head_progresses の Many(min:0) が「進捗する」扱いで zero-progress 検査をすり抜けうる (旧 Scoped/ScopeNode/IndexedRepeat の指摘は解消済み) |
...
| 2026-08-12 | design | open | [completion-query-residual-minors](./2026-08-12-completion-query-residual-minors.md) | completion_query の残 Minor — fire_path 純度 pin / emit 畳みキーの取りこぼし (RE-3・RE-6、RE-4 は解消済み) |
