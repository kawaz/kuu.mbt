...
|---|---|---|---|---|
| 2026-07-17 | design | open | [interpretation-view-filter-front-door](./2026-07-17-interpretation-view-filter-front-door.md) | interpretation view の filter 規則を front_door へ昇格する (M5d 残課題) |
