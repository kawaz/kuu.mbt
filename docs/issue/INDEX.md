...
| 2026-07-09 | bug | wip | [separator-non-string-type-parse-gap](./2026-07-09-separator-non-string-type-parse-gap.md) | separator 付き multiple の非 string 型が型 parse を経由しない (SepArg = VStr 固定) |
