---
title: completion_query の残 Minor 3 件 — fire_path 純度 pin / merge ペアキーの scope 欠落 / emit 畳みキーの取りこぼし (RE-3・RE-4・RE-6)
status: open
category: design
...
- [ ] RE-4: merge_insert_form のペアキーに scope を追加、または誤畳みの再現不能を確認
- [ ] RE-6: emit 畳みキーの取りこぼし (畳み後 spelling 未更新) を修正、または再現不能を確認
